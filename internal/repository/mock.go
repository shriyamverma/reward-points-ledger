...
type MockRepository struct {
	...
	GetRewardsByMemberIDFunc       func(ctx context.Context, id int, limit, cursorID int) ([]domain.RewardEntry, error)
	GetBalanceFunc                 func(ctx context.Context, memberID int) (int, error)
	GetMembersFunc                 func(ctx context.Context, limit, offset int) ([]domain.Member, error)
	GetRewardsFunc                 func(ctx context.Context, limit, cursorID int) ([]domain.RewardEntry, error)
	GetMemberPointSummaryFunc      func(ctx context.Context, id int) (*domain.MemberPointSummary, error)
	...
	SetPointActiveFunc             func(ctx context.Context, pointTypeID int, active bool) (*domain.Point, error)
}
...
func (m *MockRepository) GetRewardsByMemberID(ctx context.Context, id int, limit, cursorID int) ([]domain.RewardEntry, error) {
	return m.GetRewardsByMemberIDFunc(ctx, id, limit, cursorID)
}
...
func (m *MockRepository) GetAllMembers(ctx context.Context, limit, offset int) ([]domain.Member, error) {
	return m.GetMembersFunc(ctx, limit, offset)
}

func (m *MockRepository) GetAllRewards(ctx context.Context, limit, cursorID int) ([]domain.RewardEntry, error) {
	return m.GetRewardsFunc(ctx, limit, cursorID)
}

func (m *MockRepository) GetMemberPointSummary(ctx context.Context, memberID int) (*domain.MemberPointSummary, error) {
	return m.GetMemberPointSummaryFunc(ctx, memberID)
}
...
func (m *MockRepository) SetPointActive(ctx context.Context, pointTypeID int, active bool) (*domain.Point, error) {
	return m.SetPointActiveFunc(ctx, pointTypeID, active)
}
