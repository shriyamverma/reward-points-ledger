...
func (m *MockRepository) GetAllMembers(ctx context.Context) ([]domain.Member, error) {
	return m.GetMembersFunc(ctx)
}

func (m *MockRepository) GetAllRewards(ctx context.Context) ([]domain.RewardEntry, error) {
