...
type Repository interface {
	...
	GetRewardsByMemberID(ctx context.Context, id int, limit, cursorID int) ([]domain.RewardEntry, error)
	GetBalance(ctx context.Context, memberID int) (int, error)

	GetAllMembers(ctx context.Context, limit, offset int) ([]domain.Member, error)
	GetAllRewards(ctx context.Context, limit, cursorID int) ([]domain.RewardEntry, error)
